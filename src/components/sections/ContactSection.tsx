    ...
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">빠른 연락</h3>
              <div className="space-y-3">
                <a 
                  href="tel:010-5264-8027"
                  className="flex items-center p-3 bg-white rounded-lg hover:bg-green-50 transition-colors group"
                >
                  <Phone size={20} className="text-green-600 mr-3 group-hover:scale-110 transition-transform" />
                  <span className="font-medium text-gray-900">직접 전화하기</span>
                </a>
                <a 
                  href="mailto:limyoungmu@hanmail.net"
                  className="flex items-center p-3 bg-white rounded-lg hover:bg-blue-50 transition-colors group"
                >
                  <Mail size={20} className="text-blue-600 mr-3 group-hover:scale-110 transition-transform" />
                  <span className="font-medium text-gray-900">이메일 보내기</span>
                </a>
              </div>
            </div>
          </div>
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-lg font-medium transition-all flex items-center justify-center ${
        ...
        <div className="mt-16 text-center">
          <div className="bg-gray-50 rounded-2xl p-8">
            <h3 className="text-xl font-bold text-gray-900 mb-4">문의 처리 프로세스</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-white font-bold">1</span>
                </div>
                <h4 className="font-medium text-gray-900 mb-2">문의 접수</h4>
                <p className="text-sm text-gray-600">온라인 문의 폼 또는 전화</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-white font-bold">2</span>
                </div>
                <h4 className="font-medium text-gray-900 mb-2">상담 진행</h4>
                <p className="text-sm text-gray-600">전문가 배정 및 상담</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-white font-bold">3</span>
                </div>
                <h4 className="font-medium text-gray-900 mb-2">제안서 작성</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-medium text-gray-900 mb-2">프로젝트 시작</h4>
                <p className="text-sm text-gray-600">계약 체결 및 진행</p>
              </div>
            </div>
          </div>
        </div>
